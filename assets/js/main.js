...
$(function () { // ready start
  ...
  $('.instructors-list').each(function() {
    $(this).wrap("<div class='scroller'><div class='scroller-scene swiper-container'></div></div>").addClass("scroller-track swiper-wrapper");
    $('.instructors-list__item', this).addClass("swiper-slide");
    const $owner = $(this).closest('.swiper-container');
    let reward = new Swiper($owner.get(0), {
      ...
      observer: true,
      navigation: {
        nextEl: '.next-slide--instructors',
        prevEl: '.prev-slide--instructors',
      },
      breakpoints: {
        1361: {
          loopedSlides: 4,
  ...
  $('.reviews-list').each(function() {
    $(this).wrap("<div class='scroller'><div class='scroller-scene swiper-container'></div></div>").addClass("scroller-track swiper-wrapper");
    $('.reviews-list__item', this).addClass("swiper-slide");
    const $owner = $(this).closest('.swiper-container');
    let reward = new Swiper($owner.get(0), {
      speed: 800,
      slidesPerView: 'auto',
      observer: true,
      navigation: {
        nextEl: '.next-slide--reviews',
        prevEl: '.prev-slide--reviews',
      },
      breakpoints: {
        1361: {
          loopedSlides: 3,
